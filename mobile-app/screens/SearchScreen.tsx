...
const S = StyleSheet.create({
  ...
  collectionCard:     { backgroundColor: '#0D1520', borderRadius: 14, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', overflow: 'hidden', marginBottom: 10 },
  ...
  productCard:        { flexDirection: 'row', alignItems: 'flex-start', backgroundColor: '#0D1520', borderRadius: 14, padding: 14, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', gap: 12, marginBottom: 10 },
  ...
  browseCard:         { flexDirection: 'row', alignItems: 'center', gap: 14, backgroundColor: '#0D1520', borderRadius: 14, padding: 16, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
